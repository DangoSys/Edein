...
export function TopToolbar({ onClear, onCenter, onExport, onImport, onToggleTiles, onAutoLayoutAll }) {
  return (
    <header className="eda-top">
      <div className="brand">Edein</div>
      <div className="tool-btns">
        <button type="button" onClick={onCenter}>Center</button>
        <button type="button" onClick={onToggleTiles}>Toggle Tiles</button>
        <button type="button" onClick={onAutoLayoutAll}>Auto Layout All</button>
